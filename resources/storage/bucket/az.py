...
from resources.resource_group.sweden import victor_sweden_resource_group
...
s3gw_storage_keys = Output.all(
    s3gw_storage_account.name, victor_sweden_resource_group.name
).apply(
